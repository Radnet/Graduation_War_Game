...
//			HashSet<LblCarta> lstAuxLblcarta = new HashSet<LblCarta>(lstLblCartas);			
	...
	public void exibePnlCartaObjetivo() {
		ImageIcon imagemCartaVerso = new ImageIcon("resources/images/war_carta_verso.png");
	...
	private void atualizaCartasTrocaJogador() {
		...
		if(controller.getCartaJogador(0) != null) {
			ImageIcon imgcarta = new ImageIcon("resources/images/" + controller.getCartaJogador(0)[0] + ".png");
			...
			ImageIcon imgcarta = new ImageIcon("resources/images/war_carta_placeholder.png");
			lblCarta1.setIcon(imgcarta);
			lblCarta1.setImagem(imgcarta);
		}
		
		if(controller.getCartaJogador(1) != null) {
			ImageIcon imgcarta = new ImageIcon("resources/images/" + controller.getCartaJogador(1)[0] + ".png");
		...
		if(controller.getCartaJogador(2) != null) {
			ImageIcon imgcarta = new ImageIcon("resources/images/" + controller.getCartaJogador(2)[0] + ".png");
		...
		if(controller.getCartaJogador(3) != null) {
			ImageIcon imgcarta = new ImageIcon("resources/images/" + controller.getCartaJogador(3)[0] + ".png");
		...
		if(controller.getCartaJogador(4) != null) {
			ImageIcon imgcarta = new ImageIcon("resources/images/" + controller.getCartaJogador(4)[0] + ".png");
